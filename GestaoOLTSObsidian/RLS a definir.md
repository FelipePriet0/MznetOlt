...
| Ver gráfico de autorizações por dia | 👁️    |         |       |
...
| Criar OLT                                | 👁️    |         |       |
| Editar OLT                               | 👁️    |         |       |
| Detalhes da OLT  (Todas Features da aba) | 👁️    |         |       |
| Cartões OLT  (Todas Features da aba)     | 👁️    |         |       |
| Portas PON (Todas Features da aba)       | 👁️    |         |       |
| Executar scan de ONUs na OLT             | 👁️    |         |       |
| Uplinks (Todas Features da aba)          | 👁️    |         |       |
| Gerenciar VLANs (Todas Features da aba)  | 👁️    |         |       |
| Editar avançado                          | 👁️    |         |       |
